  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        questions: [
          { id: 's3q1', text: '¿Qué prevalece en caso de contradicción entre señal vertical y semáforo?', options: ['La señal vertical', 'El semáforo', 'La marca vial', 'El criterio del conductor'], correctIndex: 1, explanation: 'El orden de prioridad es: agente de tráfico > semáforo > señales verticales > marcas viales.', legalRef: 'Art. 5 RGC', category: 'señales' },
          { id: 's3q2', text: '¿Qué indica un semáforo apagado?', options: ['Vía libre sin restricciones', 'Ceda el paso a la derecha', 'Tratar como intersección sin señalizar (regla de la derecha)', 'Está prohibido pasar'], correctIndex: 2, explanation: 'Un semáforo apagado se trata como una intersección no señalizada: se aplica la regla de ceder el paso al vehículo de la derecha.', legalRef: 'Art. 59 RGC', category: 'señales' },
          { id: 's3q3', text: 'Un panel de mensaje variable que muestra una X sobre tu carril indica...', options: ['Carril de alta ocupación', 'Carril cerrado al tráfico; debes cambiar de carril', 'Velocidad máxima 60 km/h', 'Zona de peaje'], correctIndex: 1, explanation: 'La X roja sobre un carril en un panel variable indica que ese carril está cerrado. Debes incorporarte al carril adyacente con seguridad.', legalRef: 'Art. 159 RGC', category: 'señales' },
          { id: 's3q4', text: 'Las instrucciones de un agente de tráfico...', options: ['Solo son obligatorias en autopista', 'Prevalecen sobre cualquier señal o semáforo', 'Son una recomendación, no una obligación', 'Solo aplican a camiones'], correctIndex: 1, explanation: 'Los agentes de tráfico tienen la máxima autoridad sobre la circulación. Sus instrucciones prevalecen sobre señales, semáforos y marcas viales.', legalRef: 'Art. 5 LSV', category: 'señales' },
          { id: 's3q5', text: '¿Qué indica un semáforo con flecha verde?', options: ['Puedes avanzar en todas las direcciones', 'Solo puedes circular en la dirección que indica la flecha', 'Prioridad para peatones', 'Carril exclusivo para autobuses'], correctIndex: 1, explanation: 'La flecha verde indica que puedes circular únicamente en la dirección señalada por la flecha, aunque el semáforo general esté en rojo.', legalRef: 'Art. 156 RGC', category: 'señales' },
          { id: 's3q6', text: '¿Qué señal indica que está prohibido el acceso en ese sentido?', options: ['Triángulo rojo', 'Círculo rojo con barra horizontal blanca (dirección prohibida)', 'Cuadrado azul', 'Círculo azul con flecha'], correctIndex: 1, explanation: 'La señal de dirección prohibida es un círculo rojo con barra horizontal blanca. Prohíbe el acceso en ese sentido.', legalRef: 'Anexo I, R-1 RGC', category: 'señales', signId: 'direccion_prohibida' },
        ],
      },
      {
        id: 'sen_l4', title: 'Identifica la Señal', subtitle: 'Preguntas con imagen de señal real', difficulty: 'Intermedio',
        questions: [
          { id: 's4q1', text: '¿Qué indica esta señal?', options: ['Prohibido el paso en ambos sentidos', 'Parada obligatoria y completa antes de la intersección', 'Ceder el paso sin detenerse necesariamente', 'Velocidad máxima 50 km/h'], correctIndex: 1, explanation: 'La señal STOP (octogonal roja) obliga a detener COMPLETAMENTE el vehículo aunque no haya tráfico. Es diferente del Ceda el Paso, que no exige parada total.', legalRef: 'Señal R-2 · Art. 57 RGC', category: 'señales', signId: 'stop' },
          { id: 's4q2', text: '¿Qué indica esta señal?', options: ['Parada obligatoria', 'Ceder el paso a los vehículos de la vía principal', 'Prohibido girar a la izquierda', 'Fin de prioridad'], correctIndex: 1, explanation: 'El triángulo invertido (Ceda el Paso) obliga a ceder el paso. No es necesario detenerse si no viene nadie, a diferencia del STOP.', legalRef: 'Señal R-1 · Art. 57 RGC', category: 'señales', signId: 'ceda_el_paso' },
          { id: 's4q3', text: '¿Qué indica esta señal?', options: ['Velocidad recomendada de 50 km/h', 'Velocidad mínima obligatoria 50 km/h', 'Velocidad máxima permitida 50 km/h', 'Zona escolar: máximo 50 km/h'], correctIndex: 2, explanation: 'La señal circular con fondo blanco, borde rojo y número indica la VELOCIDAD MÁXIMA permitida en ese tramo. Es de cumplimiento obligatorio.', legalRef: 'Señal R-301 · Art. 48 RGC', category: 'señales', signId: 'vel_max_50' },
          { id: 's4q4', text: '¿Qué indica esta señal?', options: ['Prohibido girar a la izquierda', 'Prohibido adelantar a todos los vehículos', 'Solo permitido adelantar a motos', 'Carril de alta ocupación'], correctIndex: 1, explanation: 'La señal de prohibición de adelantamiento prohíbe adelantar a cualquier vehículo de motor. Solo pueden adelantarse bicicletas, ciclomotores y vehículos de tracción animal.', legalRef: 'Señal R-305 · Art. 82 RGC', category: 'señales', signId: 'prohibido_adelantar' },
          { id: 's4q5', text: '¿Qué indica esta señal?', options: ['Zona peatonal próxima', 'Peligro: posible presencia de peatones cruzando', 'Prohibido el paso a peatones', 'Paso de peatones con semáforo'], correctIndex: 1, explanation: 'Este triángulo de peligro con figura de peatón advierte de la posible presencia de personas cruzando. Reduce la velocidad y extrema la precaución.', legalRef: 'Señal P-17 · Art. 132 RGC', category: 'señales', signId: 'paso_peatones' },
          { id: 's4q6', text: '¿Qué indica esta señal?', options: ['Zona de talleres: circular despacio', 'Peligro: presencia de trabajadores en la calzada', 'Prohibido el paso a operarios', 'Área de servicio próxima'], correctIndex: 1, explanation: 'La señal de obras advierte de la presencia de trabajadores o maquinaria en la calzada. Reduce la velocidad y obedece las señalizaciones provisionales (amarillas).', legalRef: 'Señal P-25 · Art. 132 RGC', category: 'señales', signId: 'obras' },
          { id: 's4q7', text: '¿Qué indica esta señal?', options: ['Autopista de peaje próxima', 'Inicio de autopista', 'Fin de autopista', 'Carretera con peaje'], correctIndex: 1, explanation: 'La señal rectangular azul con el símbolo de autopista indica el inicio o la presencia de una autopista. Comienzan a aplicarse sus normas específicas.', legalRef: 'Señal I-1 · Art. 120 RGC', category: 'señales', signId: 'autopista' },
          { id: 's4q8', text: '¿Qué indica esta señal?', options: ['Peligro de viento en el mar', 'Peligro de viento lateral fuerte', 'Zona con lluvia frecuente', 'Prohibido circular con remolque'], correctIndex: 1, explanation: 'Esta señal triangular advierte de rachas de viento lateral que pueden desestabilizar el vehículo. Reduce la velocidad y agarra bien el volante.', legalRef: 'Señal P-13 · Art. 132 RGC', category: 'señales', signId: 'viento_lateral' },
          { id: 's4q9', text: '¿Qué indica esta señal?', options: ['Precaución: zona de niebla', 'Peligro: posible presencia de niños', 'Zona escolar con semáforo', 'Prohibido el acceso a menores'], correctIndex: 1, explanation: 'El triángulo con dos figuras de niños advierte de una zona frecuentada por menores (colegio, parque). Extrema la precaución y reduce la velocidad.', legalRef: 'Señal P-18 · Art. 132 RGC', category: 'señales', signId: 'ninos' },
          { id: 's4q10', text: '¿Qué indica esta señal?', options: ['Peligro de derrumbe en la vía', 'Precaución: calzada con baja adherencia (pavimento deslizante)', 'Prohibido circular con neumáticos lisos', 'Zona de firme deteriorado'], correctIndex: 1, explanation: 'El triángulo con coche derrapando advierte de una calzada con poca adherencia (hielo, grava suelta, pavimento mojado). Reduce velocidad drásticamente.', legalRef: 'Señal P-5 · Art. 132 RGC', category: 'señales', signId: 'pavimento_deslizante' },
          { id: 's4q11', text: '¿Qué indica esta señal?', options: ['Semáforo con prioridad para trenes', 'Paso a nivel sin barreras ni semáforos: peligro', 'Vía de tren paralela a la carretera', 'Prohibido cruzar vías de tren'], correctIndex: 1, explanation: 'Este triángulo con locomotora de frente indica un paso a nivel sin barreras. Debes reducir la velocidad, parar si es necesario, y asegurarte de que no viene ningún tren.', legalRef: 'Señal P-9a · Art. 132 RGC', category: 'señales', signId: 'paso_nivel_sin' },
          { id: 's4q12', text: '¿Qué indica esta señal?', options: ['Fin de todas las restricciones anteriores', 'Fin solo de la limitación de velocidad', 'Inicio de una zona de restricciones', 'Fin de zona urbana'], correctIndex: 0, explanation: 'La señal de fin de limitaciones (círculo con rayas diagonales negras) cancela TODAS las restricciones impuestas anteriormente, EXCEPTO la prohibición de adelantar.', legalRef: 'Señal R-500 · Art. 148 RGC', category: 'señales', signId: 'fin_limitaciones' },
        ],
      },
      {
        id: 'sen_l5', title: 'Señales de Obligación y Especiales', subtitle: 'Obligaciones, autopistas y marcas especiales', difficulty: 'Avanzado',
        questions: [
          { id: 's5q1', text: '¿Qué indica esta señal circular azul con flecha recta hacia arriba?', options: ['Sentido único opcional', 'Dirección obligatoria: solo puedes seguir recto', 'Velocidad mínima', 'Carril de alta velocidad'], correctIndex: 1, explanation: 'Las señales circulares azules con flechas imponen dirección obligatoria. Una flecha recta hacia arriba significa que DEBES seguir recto.', legalRef: 'Señal R-400a · Art. 149 RGC', category: 'señales', signId: 'sentido_recto' },
          { id: 's5q2', text: 'Esta señal circular azul con flecha a la derecha indica...', options: ['Recomendación de girar a la derecha', 'Obligación de girar a la derecha en ese punto', 'Carril de incorporación a la derecha', 'Solo buses y taxis pueden girar a la derecha'], correctIndex: 1, explanation: 'La señal de obligación con flecha a la derecha exige girar en esa dirección. No puedes seguir recto ni girar a la izquierda.', legalRef: 'Señal R-400b · Art. 149 RGC', category: 'señales', signId: 'sentido_derecha' },
          { id: 's5q3', text: 'Esta señal circular roja indica que...', options: ['Debes detenerte porque hay obras', 'Está prohibida la entrada a vehículos desde ese punto', 'Hay un límite de velocidad especial', 'Es una señal de aparcamiento'], correctIndex: 1, explanation: 'El círculo rojo con barra horizontal blanca (entrada prohibida) prohíbe la entrada de todos los vehículos. Es diferente de la dirección prohibida: aquí no puede entrar nadie.', legalRef: 'Señal R-101 · Art. 141 RGC', category: 'señales', signId: 'entrada_prohibida' },
          { id: 's5q4', text: 'Ves la línea continua a tu izquierda y la discontinua a tu derecha. Puedes...', options: ['Adelantar cruzando hacia la izquierda porque ves la discontinua', 'No puedes adelantar porque la línea continua está a tu izquierda', 'Adelantar solo si el otro carril está libre', 'Las dos líneas se cancelan entre sí'], correctIndex: 1, explanation: 'Cuando hay doble línea (continua + discontinua), cada conductor se rige por la línea más próxima a su carril. Si tienes la continua a tu izquierda, NO puedes cruzarla.', legalRef: 'Art. 69 RGC', category: 'señales', signId: 'linea_continua' },
          { id: 's5q5', text: '¿Cuándo debes respetar esta línea discontinua en el centro de la calzada?', options: ['Siempre puedes cruzarla cuando quieras', 'Solo cuando adelantas si la maniobra es completamente segura', 'Solo de noche', 'Nunca: la discontinua siempre se puede cruzar'], correctIndex: 1, explanation: 'Aunque la línea discontinua permite cruzarla, solo puedes hacerlo cuando la maniobra (adelantamiento, giro) sea completamente segura y no ponga en peligro a nadie.', legalRef: 'Art. 69 RGC', category: 'señales', signId: 'linea_discontinua' },
          { id: 's5q6', text: '¿Qué señal indica que existe prioridad para los vehículos que vienen en sentido contrario?', options: ['Un triángulo rojo con flecha roja grande y blanca pequeña', 'Un círculo azul con flecha doble', 'Un octógono rojo', 'Un triángulo con dos coches frontales'], correctIndex: 0, explanation: 'La señal de prioridad en sentido contrario es un triángulo con una flecha roja grande (ellos tienen prioridad) y una blanca pequeña (tú cedes). Debes esperar a que pasen los que vienen de frente.', legalRef: 'Señal R-5 · Art. 57 RGC', category: 'señales', signId: 'prioridad_sentido_contrario' },
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        questions: [
          { id: 'v1q1', text: '¿Cuál es la velocidad máxima en autopista para turismos?', options: ['100 km/h', '110 km/h', '120 km/h', '130 km/h'], correctIndex: 2, explanation: 'La velocidad máxima en autopistas y autovías es 120 km/h para turismos y motocicletas.', category: 'velocidades', signId: 'vel_max_120' },
          { id: 'v1q2', text: '¿Cuál es la velocidad máxima en carretera convencional para turismos?', options: ['70 km/h', '80 km/h', '90 km/h', '100 km/h'], correctIndex: 2, explanation: 'En carreteras convencionales fuera de poblado, el límite para turismos es 90 km/h (70 km/h sin arcén practicable).', category: 'velocidades', signId: 'vel_max_90' },
          { id: 'v1q3', text: '¿Cuál es el límite genérico en vías urbanas con dos o más carriles por sentido?', options: ['30 km/h', '40 km/h', '50 km/h', '60 km/h'], correctIndex: 2, explanation: 'En vías urbanas con dos o más carriles por sentido, el límite genérico es 50 km/h.', category: 'velocidades', signId: 'vel_max_50' },
          { id: 'v1q4', text: 'Desde mayo 2021, ¿qué límite tienen las calles urbanas de un solo carril por sentido?', options: ['20 km/h', '30 km/h', '40 km/h', '50 km/h'], correctIndex: 1, explanation: 'Desde mayo 2021, las calles urbanas con un carril por sentido y aceras a ambos lados tienen límite de 30 km/h.', category: 'velocidades', signId: 'vel_max_30' },
          { id: 'v1q5', text: '¿A qué velocidad máxima circula un turismo con remolque >750 kg en autopista?', options: ['80 km/h', '90 km/h', '100 km/h', '120 km/h'], correctIndex: 0, explanation: 'Con remolque de más de 750 kg, la velocidad máxima en autopista es 80 km/h.', category: 'velocidades', signId: 'vel_max_80' },
          { id: 'v1q6', text: '¿Cuál es la velocidad mínima en autopista?', options: ['40 km/h', '50 km/h', '60 km/h', '70 km/h'], correctIndex: 2, explanation: 'La velocidad mínima en autopista es 60 km/h (la mitad del límite máximo de 120 km/h).', category: 'velocidades', signId: 'vel_min_60' },
          { id: 'v1q7', text: '¿Qué velocidad máxima tienen los camiones pesados (>3.500 kg) en autopista?', options: ['80 km/h', '90 km/h', '100 km/h', '110 km/h'], correctIndex: 2, explanation: 'Los vehículos de más de 3.500 kg de MMA tienen un límite de 100 km/h en autopista y autovía.', category: 'velocidades', signId: 'vel_max_100' },
          { id: 'v1q8', text: '¿Cuál es el límite en una zona 20?', options: ['10 km/h', '20 km/h', '30 km/h', '40 km/h'], correctIndex: 1, explanation: 'Las zonas de coexistencia (zona 20) tienen un límite de 20 km/h. Peatones y ciclistas tienen prioridad.', category: 'velocidades', signId: 'vel_max_20' },
        ],
      },
      {
    ...
    lessons: [
      {
        ...
        questions: [
          { id: 'p1q1', text: 'En una intersección sin señalizar, ¿quién tiene prioridad?', options: ['El que llegó primero', 'El que viene por la izquierda', 'El que viene por la derecha', 'El que lleva más velocidad'], correctIndex: 2, explanation: 'La regla general es ceder el paso al vehículo que viene por la derecha cuando no hay señales que indiquen otra cosa.', category: 'preferencia', signId: 'interseccion_derecha' },
          { id: 'p1q2', text: '¿Quién tiene prioridad dentro de una rotonda?', options: ['El que va a entrar', 'El que ya circula dentro', 'El que viene por la derecha fuera de la rotonda', 'Ambos tienen la misma prioridad'], correctIndex: 1, explanation: 'El vehículo que ya circula dentro de la rotonda tiene prioridad. El que entra debe ceder el paso.', category: 'preferencia', signId: 'ceda_el_paso' },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'd1q3', text: '¿Cuál es la distancia lateral mínima al adelantar a un ciclista?', options: ['0,5 m', '1 m', '1,5 m', '2 m'], correctIndex: 2, explanation: 'Debes dejar al menos 1,5 metros de separación lateral al adelantar a un ciclista, incluso si debes invadir el carril contrario.', category: 'distancias', signId: 'ciclistas' },
          { id: 'd1q4', text: '¿Cuándo está PROHIBIDO adelantar?', options: ['En rectas largas', 'En curvas o cambios de rasante sin visibilidad suficiente', 'Cuando el de delante lleva menos de 60 km/h', 'En carretera de dos carriles'], correctIndex: 1, explanation: 'Está prohibido adelantar en curvas, cimas, pasos a nivel, intersecciones y cuando hay señal que lo prohíbe.', category: 'distancias', signId: 'prohibido_adelantar' },
          { id: 'd1q5', text: '¿Qué debes señalizar antes de comenzar un adelantamiento?', options: ['Nada', 'El intermitente derecho', 'El intermitente izquierdo', 'Las luces de emergencia'], correctIndex: 2, explanation: 'Antes de adelantar activa el intermitente izquierdo. Una vez reincorporado, señaliza con el intermitente derecho.', category: 'distancias', signId: 'prohibido_adelantar' },
