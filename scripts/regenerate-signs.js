...
const FINAL_SIGNS = [
  ...
  { signId: 'paso_nivel_con_barreras', code: 'P-7', source: 'file', filename: 'p7.svg',
  ...
  { signId: 'estrechamiento_calzada', code: 'P-17', source: 'inline', inlineKey: 'estrechamiento_calzada',
    desc: 'Estrechamiento de calzada' },
  { signId: 'obras', code: 'P-18', source: 'file', filename: 'p18.svg',
  ...
  { signId: 'ninos', code: 'P-21', source: 'file', filename: 'p21.svg',
    desc: 'Niños cerca (zona escolar)' },
  { signId: 'ciclistas', code: 'P-22', source: 'file', filename: 'p22.svg',
    desc: 'Lugar frecuentado por ciclistas' },
  { signId: 'desprendimientos', code: 'P-26', source: 'file', filename: 'p26.svg',
    desc: 'Desprendimientos (piedras u obstáculos en la calzada)' },
  ...
  { signId: 'vel_max_50', code: 'R-301', source: 'file', filename: 'vel_max_50.svg', desc: 'Velocidad máxima 50 km/h' },
  ...
  // ─── OBLIGACIÓN ───────────────────────────────────────────
  { signId: 'obligacion_ir_derecha', code: 'R-400a', source: 'inline', inlineKey: 'obligacion_ir_derecha',
    desc: 'Obligación de ir hacia la derecha' },
  { signId: 'obligacion_ir_izquierda', code: 'R-400b', source: 'inline', inlineKey: 'obligacion_ir_izquierda',
  ...
  // ─── INDICACIÓN ───────────────────────────────────────────
  { signId: 'autovia', code: 'S-1a', source: 'inline', inlineKey: 'autovia',
